...
The Sumcash daemon can be configured to act as a trusted "border
...
The ZeroMQ feature in Sumcash requires the ZeroMQ API >= 4.0.0
...
using. Sumcashd appends an up-counting sequence number to each
