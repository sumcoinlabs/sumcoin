...
The minimum relay fee `-minrelayfee` has been lowered to 0.01 mSUM per kB (0.00001 SUM). This is to prepare for dropping the minimum transaction fee to 0.1 mSUM per kB (0.0001 SUM) in the next release.
