...
# Pick some path to install BDB to, here we create a directory within the sumcoin directory
BDB_PREFIX="${SUMCOIN_ROOT}/db4"
mkdir -p $BDB_PREFIX
...
# Configure Sumcoin Core to use our own-built instance of BDB
cd $SUMCOIN_ROOT
./autogen.sh
...
with 4.8-built Sumcoin Core is needed follow the steps under "Berkeley DB" above.
