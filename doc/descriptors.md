# Support for Output Descriptors in Sumcoin Core

Since Sumcoin Core v0.17, there is support for Output Descriptors. This is a
...
- Segwit addresses (bech32, of the form `sum1...` for mainnet or `tsum1...` for testnet, defined in [BIP 173](https://github.com/bitcoin/bips/blob/master/bip-0173.mediawiki)).
...
on Sumcoin's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Sumcoin Core wallets, a convenience function `combo` is
