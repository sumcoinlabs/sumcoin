...
* sumcoin.conf: contains configuration settings for sumcoind or sumcoin-qt
* sumcoind.pid: stores the process id of sumcoind while running
...
* debug.log: contains debug information and general logging generated by sumcoind or sumcoin-qt
