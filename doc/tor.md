...
## 1. Run Sumcoin Core behind a Tor proxy

The first step is running Sumcoin Core behind a Tor proxy. This will already anonymize all
...
- Do not add anything but Sumcoin Core ports to the hidden service created in section 2.
