...
bech32_templates = [
  ...
  ('sum',   0, 20, (False, 'main',    None, True), p2wpkh_prefix),
  ('sum',   0, 32, (False, 'main',    None, True), p2wsh_prefix),
  ('sum',   1,  2, (False, 'main',    None, True), (OP_1, 2)),
  ('tsum',  0, 20, (False, 'test',    None, True), p2wpkh_prefix),
  ('tsum',  0, 32, (False, 'test',    None, True), p2wsh_prefix),
  ('tsum',  2, 16, (False, 'test',    None, True), (OP_2, 16)),
  ('rsum',  0, 20, (False, 'regtest', None, True), p2wpkh_prefix),
  ('rsum',  0, 32, (False, 'regtest', None, True), p2wsh_prefix),
  ('rsum', 16, 40, (False, 'regtest', None, True), (OP_16, 40))
]
# templates for invalid bech32 sequences
bech32_ng_templates = [
  # hrp, version, witprog_size, invalid_bech32, invalid_checksum, invalid_char
  ('tc',    0, 20, False, False, False),
  ('tsum',  17, 32, False, False, False),
  ('rsum',  3,  1, False, False, False),
  ('sum',   15, 41, False, False, False),
  ('tsum',  0, 16, False, False, False),
  ('rsum',  0, 32, True,  False, False),
  ('sum',   0, 16, True,  False, False),
  ('tsum',  0, 32, False, True,  False),
  ('rsum',  0, 20, False, False, True)
]
