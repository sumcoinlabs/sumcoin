// Copyright (c) 2009-2010 1 Nakamoto
...
CTxMemPoolEntry::CTxMemPoolEntry(const CTransactionRef& _tx, const CAmount& _nFee, int64_t _nTime, unsigned int _entryHeight, bool _spendsCoinbase, int64_t _sigOpsCost, LockPoints lp)
...
CTxMemPool::CTxMemPool() : nTransactionsUpdated(0), m_epoch(0), m_has_epoch_guard(false)
{
...
void CTxMemPool::addSpentIndex(const CTxMemPoolEntry& entry, const CCoinsViewCache& view)
{
    ...
    for (unsigned int j = 0; j < tx.vin.size(); j++) {
        ...
        CSpentIndexValue value = CSpentIndexValue(txhash, j, -1, prevout.nValue / 1, addressType, addressHash);
