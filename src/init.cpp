...
bool AppInit(int argc, char* argv[])
{
    ...
    try
    {
        ...
        if (mapArgs.count("-?") || mapArgs.count("--help"))
        {
            ...
            std::string strUsage = _("Sumcoin version") + " " + FormatFullVersion() + "\n\n" +
                _("Usage:") + "\n" +
                  "  sumcoind [options]                     " + "\n" +
                  "  sumcoind [options] <command> [params]  " + _("Send command to -server or sumcoind") + "\n" +
                  "  sumcoind [options] help                " + _("List commands") + "\n" +
                  "  sumcoind [options] help <command>      " + _("Get help for a command") + "\n";
        ...
        for (int i = 1; i < argc; i++)
            if (!IsSwitchChar(argv[i][0]) && !boost::algorithm::istarts_with(argv[i], "sumcoin:"))
                fCommandLine = true;
...
std::string HelpMessage()
{
    string strUsage = _("Options:") + "\n" +
        "  -?                     " + _("This help message") + "\n" +
        "  -conf=<file>           " + _("Specify configuration file (default: sumcoin.conf)") + "\n" +
        "  -pid=<file>            " + _("Specify pid file (default: sumcoind.pid)") + "\n" +
        ...
        "\n" + _("SSL options: (see the Sumcoin Wiki for SSL setup instructions)") + "\n" +
