...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s sumcoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  sumcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded sumcoin transaction") + "\n" +
              "  sumcoin-tx [options] -create [commands]   " + _("Create hex-encoded sumcoin transaction") + "\n" +
              "\n";
