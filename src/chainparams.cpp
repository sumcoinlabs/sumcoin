...
public:
    CMainParams() {
        ...
        consensus.nMinimumChainWork = uint256S("0x0000000000000000000000000000000000000000000000001698ceb7e42462e3"); // to block 1077120

        // By default assume that the signatures in ancestors of this block are valid.
        consensus.defaultAssumeValid = uint256S("0x259ec9e319169f587e3f9f8e38a0bfd5ca0cbc33a1e7c05c51b9b93fd1d17458"); //1077120
        ...
        vSeeds.emplace_back("dnsseed.sumcoinpool.org", true);
        vSeeds.emplace_back("dnsseed.jandsmining.com", true);
        vSeeds.emplace_back("dnsseed.sumnode.io", true);
        vSeeds.emplace_back("dnsseed.sumcoin.space", true);
        vSeeds.emplace_back("dnsseed.sumcoinmining.org", false);
