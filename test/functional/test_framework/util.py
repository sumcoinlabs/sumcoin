...
def initialize_datadir(dirname, n, chain):
    ...
    with open(os.path.join(datadir, "sumcash.conf"), 'w', encoding='utf8') as f:
...
def get_auth_cookie(datadir, chain):
    user = None
    password = None
    if os.path.isfile(os.path.join(datadir, "sumcash.conf")):
        with open(os.path.join(datadir, "sumcash.conf"), 'r', encoding='utf8') as f:
            for line in f:
