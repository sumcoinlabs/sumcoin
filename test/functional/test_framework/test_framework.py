...
class BitcoinTestFramework(metaclass=BitcoinTestMetaClass):
    ...
    def setup(self):
        ...
        self.config = config
        self.options.bitcoincli = os.getenv("BITCOINCLI", default=config["environment"]["BUILDDIR"] + '/src/sumcoin-cli' + config["environment"]["EXEEXT"])
    ...
    def _start_logging(self):
        ...
        ch.setLevel(ll)
        # Format logs the same as sumcoind's debug.log with microprecision (so log files can be concatenated and sorted)
