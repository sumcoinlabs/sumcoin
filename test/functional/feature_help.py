...
"""Verify that starting sumcoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start sumcoin with -h for help text")
        ...
        self.log.info("Start sumcoin with -version for version information")
        ...
        self.log.info("Start sumcoind with -fakearg to make sure it does not start")
